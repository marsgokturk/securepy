...
def input_guardrail(openai_client, model: str, user_input: str):
    ...
    """
    system_prompt = """
    You are an LLM input guardrail for a secure code analysis application. The purpose of this application is to detect security vulnerabilities in user-submitted Python code using AI pipeline.
